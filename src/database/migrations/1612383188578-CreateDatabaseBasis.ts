...
export class CreateDatabaseBasis1612383188578 implements MigrationInterface {
  name = 'CreateDatabaseBasis1612383188578';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "provided_services" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "service_type" uuid NOT NULL, "name" character varying NOT NULL, "provider_id" uuid NOT NULL, "value" character varying NOT NULL, "description" character varying NOT NULL, "due_date" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c5c8fbcec073614e8cd7c0af0ee" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
